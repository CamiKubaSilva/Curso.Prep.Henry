...
function crearGato(nombre, edad) {
  // Crear un nuevo objeto con la propiedad "nombre" y el valor definido como 
  //  el argumento "nombre".
...
function verificarPassword(usuario, password) {
  // Comprueba si la "password" enviada coincide con la propiedad "password" 
  // del objeto "usuario"
...
producto['calcularPrecioDescuento'] = 
          ...
          function calcularPrecioDescuento() {
              ...
              var descuento = this.precio * this.porcentajeDeDescuento ;
                  ...
                  var producto2 = this.precio - descuento;
